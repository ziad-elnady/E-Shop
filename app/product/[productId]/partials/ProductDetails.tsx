...
const ProductDetails: React.FC<ProductDetailsProps> = ({ product }) => {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <ProductImages product={product} cartProduct={cartProduct} handleImageSelection={handleColorSelection} />
            <div className="flext flex-col gap-1 text-gray-500 text-sm">
                ...
                <div className={product.inStock ? 'text-green-600' : 'text-rose-400'}>{product.inStock ? 'In stock' : 'Out of stock'}</div>
                <LineBreak />
                {isProductInCart ? (
                    <>
                    ...
                    <>
                        <ColorPicker images={product.images} cartProduct={cartProduct} handleColorSelection={handleColorSelection} />
                        <LineBreak />
                        <ProductQuantity cartCounter={false} cartProduct={cartProduct} handleQtnDecrease={handleQtnDecrease} handleQtnIncrease={handleQtnIncrease} />
                        <LineBreak />
                        <div className="max-w-[300px]">
